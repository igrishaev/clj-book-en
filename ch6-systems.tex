...
\textbf{Sharing components}: In Integrant, it is easier to access the system from an HTTP request. The handler can be a database-dependent component. Let the page display the number of records in the database. Let's add a new key and a reference to the database to the system:
